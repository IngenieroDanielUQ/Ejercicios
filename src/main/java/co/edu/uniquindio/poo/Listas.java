...
public class Listas {
     ...
     * @return Objeto Respuesta con las dos listas
     */
    public Respuesta crearListas(ArrayList<String> palabras) {
        ...
        // Se crea un objeto Respuesta con las dos listas
        return new Respuesta(listaVocales, listaConsonantes);
    }

    /**
     * Método que recibe una palabra y devuelve true si la palabra empieza y termina
     * con consonante
     * 
